...
MODID_REF = 'shadesofnether'

# This is the actual modid as used in json for example
MODID = 'shadesofnether'

# The root package of your mod
ROOT_PACKAGE = 'com.shades.pyros.ShadesOfNether'

# The relative path to the mod root (where your main mod file is located)
SOURCE_ROOT = 'ShadesOfNether/src/main/java/com/shade/pyros/shadesofnether'
# The relative path to the root of your asset resources
ASSET_RESOURCE_ROOT = 'ShadesOfNether/src/main/resources/assets/shadesofnether'
# The relative path to the root of your data resources
DATA_RESOURCE_ROOT = 'ShadesOfNether/src/main/resources/data/shadesofnether'
...
PACKAGE_TILES = 'TileEntities'
PACKAGE_CONTAINERS = 'Containers'
PACKAGE_SCREENS = 'gui.screen'
