...
public class AsherBiome extends Biome{
	...
	protected AsherBiome() {
			super(
				(new Biome.Builder())
				.surfaceBuilder(ModSurfaceBuilders.ASHER_SURFACE_BUILDER, ASHER_SBC)
			...
			this.addStructure(Features.ASHER_MINE, IFeatureConfig.NO_FEATURE_CONFIG);
			...
			this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(ForgeRegistries.ENTITIES.getValue(ModEntities.CLAYSPIDER.getRegistryName()), 20, 4, 6));
