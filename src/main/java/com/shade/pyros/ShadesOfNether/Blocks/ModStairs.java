...
public class ModStairs extends Block implements IWaterLoggable {
   ...
   public ModStairs(BlockState state, Block.Properties properties) {
      super(properties);
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof ModStairs;
   }
