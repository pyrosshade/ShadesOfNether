...
public class VanillaWorkBench extends RecipeBookContainer<CraftingInventory>{
    ...
    public VanillaWorkBench(int p_i50090_1_, PlayerInventory p_i50090_2_) {
        this(p_i50090_1_, p_i50090_2_, IWorldPosCallable.DUMMY);
    }

    public VanillaWorkBench(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
