...
public class ModBarrelTE extends LockableLootTileEntity {
	private NonNullList<ItemStack> inventory;
	private int field_213967_b;
	
	public ModBarrelTE(TileEntityType<?> p_i49963_1_) {
		super(p_i49963_1_);
	...
	public ItemStack decrStackSize(int p_70298_1_, int p_70298_2_) {
		return ItemStackHelper.getAndSplit(this.inventory, p_70298_1_, p_70298_2_);
	}

	public ItemStack removeStackFromSlot(int p_70304_1_) {
		return ItemStackHelper.getAndRemove(this.inventory, p_70304_1_);
	}
