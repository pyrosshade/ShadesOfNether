...
public class InventoryHelper {
	...
	//    return te instanceof ModBarrelTE ? calcRedstoneFromInventory(((ModBarrelTE) te).handler) : 0;
	//  }
    //
	...
	//    }
	//  public static int calcRedstoneFromInventory(@Nullable ItemStackHelper inv) {
	//	    if (inv == null) {
	//	      return 0;
	//	    } else {
	//	      int i = 0;
